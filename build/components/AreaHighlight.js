...
var AreaHighlight = /*#__PURE__*/function (_Component) {
  ...
  _createClass(AreaHighlight, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          otherProps = _objectWithoutProperties(_this$props, ["highlight", "onChange"]);

      return /*#__PURE__*/_react["default"].createElement(_reactRnd.Rnd, _extends({
        className: "AreaHighlight",
        onDragStop: function onDragStop(_, data) {
          var boundingRect = _objectSpread(_objectSpread({}, highlight.position.boundingRect), {}, {
            top: data.y,
            left: data.x
          });
